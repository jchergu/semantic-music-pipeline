# 8.1 Evaluation Tables (LEGACY)

> **LEGACY / DO NOT CITE.** Generated 2026-08-31 against the frozen
> 4110-row `recommendations` table under the *original* `related_by_genre`
> Cypher query (`LIMIT 10`, no `ORDER BY` — arbitrary candidate selection).
> Superseded 2026-09-01 (Stage 15A.2) by `eval/8_1/tables.md`, generated
> against a validated-identical regenerated table under the Stage 15A
> ordered query. Retained for provenance only.
...
|---|---|---|---|
| Milvus ANN | 3.7 | 5.773 | 4.188 |
| Neo4j | 4.177 | 7.777 | 5.299 |
| Ranking | 0.22 | 0.499 | 0.224 |
| Total | 8.125 | 13.552 | 9.712 |
